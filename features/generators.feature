Feature:
  ...
  Scenario: The factory_girl_rails generators create a factory file for each model if there is a factories directory without a factories.rb file
  ...
  Scenario: The factory_girl_rails generators does not create a factory file for each model if there is a factories directory with a factories.rb file
    When I run `bundle install` with a clean environment
